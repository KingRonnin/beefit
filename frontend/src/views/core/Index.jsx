    ...
    <div className="front-page">
      ...
      <section id="home" className="section home-section" ref={homeSectionRef}>
        <header
          ...
          style={{ backgroundImage: `url(${hbdImage})` }}
        >
          ...
          <div className="pricing-plans-container">
            <div className="pricing-plan">
              <div className="plan-details">
                ...
                <button className="join-now-cta" onClick={handleJoinNowClick}>
                  JOIN NOW
                </button>
              </div>
            </div>
      ...
      >
        ...
        <button
          className="offers-cta-button"
          onClick={handleCheckOurPlansClick}
        >
          Check Our Plans
        </button>
      </section>
      ...
      >
        <div className="content">
          <h2>Contact Us</h2>
          <p>
            Get in touch for any inquiries or support. We’re here to help you
